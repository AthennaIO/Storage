...
export class NotFoundDriverException extends Exception {
  public constructor(driverName: string) {
    ...
    super({
      ...
      help: `Available drivers are: ${availableDrivers}. Look into your config/storage file if ${driverName} driver is implemented by storage. Or create ${driverName} driver implementation using DriverFactory.createDriver("${driverName}", ...) method.`
    })
  }
}
